...
En ese camino nos topamos con [**rtk**](https://github.com/rtk-ai/rtk) (Rust Token Killer). Ver cómo rtk seguía escalando en adopción fue lo que nos empujó a dejar de tratar nuestro trabajo como tooling interno y publicarlo. trs nació de iniciativa propia — lo fuimos iterando y expandiendo conforme aprendíamos más sobre dónde se queman realmente los tokens.
