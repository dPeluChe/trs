...
- **parse:** Maven and Gradle parsers (#178)
...
- **compress:** Fold repeats as (xN) and cut dense lines, safely for any output (#171)
- **compress:** Fold log lines that differ only in their timestamps (#172)
- **init:** Copilot CLI support, and doctor warns when a hook never fired (#173)
